...
public class UserBusinessMatrixCONUSER_E_BUSINESS {
	 ...
	 * @param userMap 
	 */
	public UserBusinessMatrixCONUSER_E_BUSINESS(List<User> users, Map<String, Business> business, List<Review> reviews) {
	 ...
	 */
	public UserBusinessMatrixCONUSER_E_BUSINESS() {
		this.matrix = new HashMap<User, Map<Business, Integer>>();
	}
